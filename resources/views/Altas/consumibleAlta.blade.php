...
<form role="form" method="post" action="{{ url('/Altas/Consumibles/altaConsumible') }}">
		...
		<fieldset>
			...
			<p>
                ...
                <label for ="precio">Precio</label>: <input type="money" name = "precio" id = "precio"size = "30" min="1" placeholder="Precio" required><br/>
				<label for ="costo">Existencias</label>: <input type="money" name = "costo" id = "costo"size = "30" min="1" placeholder="Costo" required><br/>
				<hr>
				<div class = "boton">
