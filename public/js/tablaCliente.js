$("#add").click(function () {
    var tds = '<tr>';
    tds += '<td style="width: 7.0%; min-width: 7.0%;"><input type="text" name="RFC[]" maxlength = "13" placeholder="rfc" required style="text-align: center; min-width: 100%; width:100%;"></td>'
