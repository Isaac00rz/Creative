$("#add").click(function () {
    var tds = '<tr>';
    tds += '<td style="width: 11%; min-width: 11%;"><input type="text" name="Nombre[]" maxlength = "20" placeholder="nombre" required style="text-align: center; min-width: 100%; width:100%;"></td>'
    tds += '<td style="width: 11%; min-width: 11%;"><input type="text"name="Descripción[]" maxlength = "250" placeholder="descripción" required style="text-align: center; min-width: 100%; width:100%;"></td>'
