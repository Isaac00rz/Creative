$("#add").click(function () {
    var tds = '<tr>';
    tds += '<td style="width: 11%; min-width: 11%;"><input type="text" name="modelo[]" maxlength = "15" placeholder="modelo" required style="text-align: center; min-width: 100%; width:100%;"></td>'
    tds += '<td style="width: 11%; min-width: 11%;"><input type="text"name="marca[]" maxlength = "15" placeholder="marca" required style="text-align: center; min-width: 100%; width:100%;"></td>'
